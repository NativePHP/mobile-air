...
- Use `native:icon` (SF Symbols on iOS, Material Icons on Android) for iconography — never emoji characters in
  ...
  (`Ios`, `Android`, `AndroidOutlined`) bound via the `:ios` / `:android` attributes, e.g.
  `:ios="Ios::Gearshape" :android="Android::Settings"`, over string names. The enum catalogs are generated by
  the `nativephp/mobile-ui` package (`composer require nativephp/mobile-ui`); see its guidelines for
  generating and importing them.
