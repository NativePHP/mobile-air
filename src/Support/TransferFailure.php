 ...
 *
 * Guzzle folds the response body into the exception message, so a CDN
...
class TransferFailure
{
    ...
    {
        // method_exists() rather than instanceof RequestException: Guzzle 8
        // moved getResponse() off RequestException onto ResponseException.
